...
@Component({
  selector: 'app-debrief-creatif3',
  templateUrl: './debrief-creatif3.component.html',
  styleUrls: ['./debrief-creatif3.component.css']
})
export class DebriefCreatif3Component implements OnInit {
